    ...
    public static partial class TestData
    {
        ...
        private readonly static Item[] RealItems = new Item[]
        {
            ...
            new Ammunition()
            {
                ...
                Caliber = "Caliber9x19PARA",
                CategoryId = "ammunition",
                DurabilityBurnModifierPercentage = 1.7,
                FleshDamage = 52,
                FragmentationChance = 0.05,
                HeavyBleedingChance = 0,
            ...
            new ArmorMod()
            {
                ...
                ShortName = "ESAPI IV",
                TurningSpeedModifierPercentage = -0.005,
                Weight = 3.2,
            ...
            new ArmorMod()
            {
                ...
                ImageLink = "https://assets.tarkov.dev/64afc71497cf3a403c01ff38-image.webp",
                MarketLink = "https://tarkov.dev/item/granit-br5-ballistic-plate",
                Material = "Ceramic",
                MovementSpeedModifierPercentage = -0.02,
                Name = "Granit Br5 ballistic plate",
                ShortName = "Granit Br5",
                TurningSpeedModifierPercentage = -0.015,
                Weight = 3.3,
            ...
            new ArmorMod()
            {
                ...
                Material = "Ceramic",
                MovementSpeedModifierPercentage = -0.0075,
                Name = "Granit ballistic plate (Side)",
                ShortName = "Granit Side",
                TurningSpeedModifierPercentage = -0.0075,
                Weight = 1.3,
            ...
            new RangedWeaponMod()
            {
                ...
                RecoilModifierPercentage = -0.015,
                ShortName = "Shift",
                Weight = 0.09,
