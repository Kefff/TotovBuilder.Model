...
{
    /// <summary>
    /// Represents a JSON converter for the <see cref="IMod"/> interface.
    /// </summary>
    ...
    public sealed class ModJsonConverter<TInterface, TClass> : ReducedJsonConverter<TInterface, TClass>
        where TInterface : IMod
        where TClass : class, TInterface
    {
        ...
        {
            { nameof(IMod.ErgonomicsModifier), c => c.ErgonomicsModifier == 0 }
        };
